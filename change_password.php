...
<head>
        ...
        <title>Lavie || Change Password</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-xs-12 lr2">
                <form method="post" action="php\process_change_password.php">
              <div class="login-reg">
                <h3>Change Password</h3>
                
                <div class="form-group">
                    <label class="control-label">Old Password</label>
                    <input type="password" class="form-control" placeholder="Password" value="" name="old">
                </div>
				<div class="form-group">
                    <label class="control-label">New Password</label>
                    <input type="password" class="form-control" placeholder="Password" value="" name="new">
                </div>
				<div class="form-group">
                    <label class="control-label">Confirm Password</label>
                    <input type="password" class="form-control" placeholder="Password" value="" name="cnfnew">
                </div>
                </div>
                <div class="frm-action">
                    <div class="input-box tci-box">
                        <input type="submit" value="Change Password" name="processed-checkout" class="in-btn">
                    </div>
                </div> 
                </form>                      
            </div>                     
