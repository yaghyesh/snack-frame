                            ...
                            <ul>             
                                ...
                                <li><a href="index.php">Shop</a>
                                    <ul>
                                        ...
                                        <li><a href="index-2.php">Checkout</a></li>
                                    </ul>
                                </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-xs-12 lr2">
                <form method="post" action="php\process_registration.php">
              <div class="login-reg">
                <h3>Register</h3>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Your IITK roll no." value="" name="roll">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label">E-Mail</label>
                    <input type="text" class="form-control" placeholder="Your IITK E-Mail" value="" name="email">
                </div>
                <div class="form-group">
                    <label class="control-label">Password</label>
                    <input type="password" class="form-control" placeholder="Password" value="" name="password">
                ...
                <div class="frm-action">
                    <div class="input-box tci-box">
                        <input type="submit" value="Register" name="processed-checkout" class="in-btn">
                    </div>
                </div> 
                </form>                      
            </div>                     
