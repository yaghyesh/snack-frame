...
$sql1 = "SELECT * FROM transactions where username='".$_SESSION['roll']."'";
...
<head>
        ...
        <title>Snack Frame || Previous</title>
...
<div class="login-wraper">
    ...
    <div class="container">
        <div class="row">
            <div>
			  <center><h2>Previous Orders</h2></center><br>
                    ...
                    <table class="shop_table cart table">
                        <thead>
							 <tr>
                                ...
                                <th class="product-price">Roll No.</th>
                                <th class="product-price">Item</th>
                                <th class="product-price">Quantity</th>
                                <th class="product-price">Price</th>
                                <th class="product-price">Date</th>
                                <th class="product-price">Time</th>
                                <th class="product-price">Transaction Id</th>
                                <th class="product-price">Recieved</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php
